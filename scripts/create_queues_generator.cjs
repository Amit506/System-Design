...
const ch10_deepdive = [
{
    ...
    "tags": ["kafka", "rabbitmq", "sqs", "queues", "streams", "messaging"],
    ...
    "tradeoffs": {
        "pros": ["Decouples monolithic services", "Absorbs spiky unpredictable traffic", "Allows asynchronous retries"],
        "cons": ["Drastically increases system complexity and observability requirements", "Introduces Eventual Consistency (Users might not see their own updates instantly)", "Message ordering pitfalls"],
    ...
    "related_topics": [
        { "id": "ch11", "title": "Concurrency Control", "relationship": "Provides mechanisms for idempotent handlers" },
        { "id": "ch13", "title": "Resiliency", "relationship": "DLQs, Retry policies, and Circuit Breakers" }
    ],
    "references": [
        { "title": "Kafka's Log-centric Architecture", "url": "https://engineering.linkedin.com/distributed-systems/log-what-every-software-engineer-should-know-about-real-time-datas-unifying" }
    ]
}
];

fs.writeFileSync('/Users/211446/Grokking-System-Design/scripts/build_queues_deep_dive.cjs', 
    'const fs = require("fs");\n\n' +
    'const ch10_data = ' + JSON.stringify(ch10_deepdive, null, 4) + ';\n\n' +
...
console.log('Script written to scripts folder.');
